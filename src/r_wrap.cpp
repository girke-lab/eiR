...
SWIGEXPORT SEXP
R_swig_binaryCoord ( SEXP inFile, SEXP outFile, SEXP dim, SEXP s_swig_copy)
{
  int result;
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  ...
  arg1 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(inFile, 0))));
  arg2 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(outFile, 0))));
  arg3 = static_cast< int >(INTEGER(dim)[0]);
  result = (int)binaryCoord(arg1,arg2,arg3);
...
SWIGEXPORT SEXP
R_swig_getSolver ( SEXP r, SEXP d, SEXP refCoords)
{
  Solver *result = 0 ;
  int arg1 ;
  int arg2 ;
  ...
  arg1 = static_cast< int >(INTEGER(r)[0]);
  arg2 = static_cast< int >(INTEGER(d)[0]);
  {
    {
      int _rswigi;
      int _rswiglen = LENGTH(refCoords);
      arg3 = static_cast< double * >(calloc(sizeof(double), _rswiglen));
      for (_rswigi=0; _rswigi<_rswiglen; _rswigi++) {
        arg3[_rswigi] = REAL(refCoords)[_rswigi];
      }
    }
  }
  result = (Solver *)getSolver(arg1,arg2,arg3);
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Solver, R_SWIG_EXTERNAL |  0 );
...
SWIGEXPORT SEXP
R_swig_eucsearch2file ( SEXP matrix, SEXP queryMatrix, SEXP n_results, SEXP outfile, SEXP s_swig_copy)
{
  int result;
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(matrix, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "eucsearch2file" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_AsCharPtrAndSize(queryMatrix, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "eucsearch2file" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = reinterpret_cast< char * >(buf2);
  arg3 = static_cast< int >(INTEGER(n_results)[0]);
  arg4 = reinterpret_cast< char * >(SWIG_strdup(CHAR(STRING_ELT(outfile, 0))));
  result = (int)eucsearch2file((char const *)arg1,(char const *)arg2,arg3,arg4);
  r_ans = Rf_ScalarInteger(result);
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
   {"R_swig_getSolver", (DL_FUNC) &R_swig_getSolver, 3},
   {"R_swig_binaryCoord", (DL_FUNC) &R_swig_binaryCoord, 4},
   {"R_swig_eucsearch2file", (DL_FUNC) &R_swig_eucsearch2file, 5},
   {NULL, NULL, 0}
};

extern "C" SWIGEXPORT void R_init_eiR(DllInfo *dll) {
